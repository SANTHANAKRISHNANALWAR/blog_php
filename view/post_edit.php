...
require_once "../controller/post_edit_file.php";
...
<body>
    ...
    <header>
        <nav class="navbar bg-body-tertiary bg-success shadow-lg py-4">
            <div class="container">
                <a href="../view/profile.php" class="navbar-brand btn btn-success p-2 text-white">Home</a>
                ...
                <div class="row">
                    <div class="col-lg-6 mx-auto p-5">
                        <div class="shadow-lg border border-1 rounded p-4">
                            <h1 class="text-white text-center py-2 bg-success mb-3 rounded">Edit Post</h1>
                            <form action="../controller/post_edit_file.php" method="POST" enctype="multipart/form-data">
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="author_name" value="<?php echo $edit_author; ?>" class="form-control"
